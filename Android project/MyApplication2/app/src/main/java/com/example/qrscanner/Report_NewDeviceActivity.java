...
/**
 * ユーザーのQRコードをスキャンし、結果画面へ遷移する
 */
public class Report_NewDeviceActivity extends AppCompatActivity {
    ...
    // --- Business: Scan U code and submit ---
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lend); // Use existing lend layout for scanning
    ...
    // --- Business: Classify U, submit, and stop ---
    ...
    private void handleScannedText(String raw) {
        ...
        if (changed) {
            runOnUiThread(() -> {
                tvResult.setText("ユーザー: " + userCode);
            });
        }
    ...
    private void maybeNavigateToResult() {
        if (userCode != null) {
            ...
            Intent intent = new Intent(this, Report_NewDeviceResultActivity.class);
            // Pass the scanned user code to the next activity
